...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="tabs-2">
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ODWConnectionString %>"
            SelectCommand="SELECT [URLNAME] FROM [ODW].[EAMS].[Attachment] where OWNERID IN (SELECT WORKORDERID  FROM [ODW].[GIS].[vwWorkOrder]  where WONUM= @ID) AND OWNERTABLE='WORKORDER' AND not (URLNAME LIKE '%JPG' OR URLNAME LIKE '%PNG' OR URLNAME LIKE '%GIF' OR URLNAME LIKE '%JPEG')">
            <SelectParameters>
