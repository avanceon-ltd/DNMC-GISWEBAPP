...
<body style="background-color: #022130; font-family: Segoe UI Light; color: white;">
    ...
    <form id="form1" runat="server" style="text-align: center;">
        ...
        <div style="text-align: left; float: left; font-family: Segoe UI Light; font-size: Small;">Vehicle: <%=Request.QueryString["PlateNumber"]%> -->Associated WorkOrders</div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ODWConnectionString %>"
            SelectCommand="SELECT wv.[WONUM],wv.[PlateNumber],wv.[IsAssigned]  ,wv.[CreatedDate] ,wv.[CreatedBy], w.[WODescription],w.[Status_Description] FROM [ODW].[AVLS].[vwWorkOrderVehicleAssignment] wv left join [ODW].[GIS].[vwWorkOrderBase] w
  on wv.[WONUM]=w.[WONUM] where wv.[PlateNumber] = @PlateNumber">
            <SelectParameters>
                <asp:QueryStringParameter DbType="String" DefaultValue="8737054" Name="PlateNumber" QueryStringField="PlateNumber" />
            </SelectParameters>
        </asp:SqlDataSource>

        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ODWConnectionString %>"
            SelectCommand="SELECT Count(*) AS TotalRows FROM [ODW].[AVLS].[vwWorkOrderVehicleAssignment] where ([PlateNumber] = @PlateNumber)">
            <SelectParameters>
                <asp:QueryStringParameter DbType="String" DefaultValue="8737054" Name="PlateNumber" QueryStringField="PlateNumber" />
            </SelectParameters>
        </asp:SqlDataSource>
        <asp:GridView ID="gvCustomers" CssClass="Grid" Font-Size="12px" Font-Names="Segoe UI Light" runat="server" AutoGenerateColumns="false" CellPadding="16" CellSpacing="16" DataSourceID="SqlDataSource1" OnRowDeleting="OnRowDeleting" OnRowDataBound="OnRowDataBound">
            <Columns>
                ...
                <asp:BoundField DataField="PlateNumber" HeaderText="Plate Number" ItemStyle-HorizontalAlign="Left" />
