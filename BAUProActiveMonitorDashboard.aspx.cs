...
{
    public partial class BAUProActiveMonitorDashboard : System.Web.UI.Page
    {
        ...
        private DataTable GetESRIDataCount()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                //using (SqlCommand cmd = new SqlCommand("SELECT [Description],[Count],[UpdatedOn] AS [Last Updated Time] FROM [ESRI].[Rest_Services_Data_Count] "))
                {
                    using (SqlDataAdapter sda = new SqlDataAdapter())
                    {
                        cmd.Connection = con;
        ...
        private DataTable GetESRIRecentData()
        {
            ...
            using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("SELECT [LayerName],[EntryType],[Service_Request_Number],[Application_Status],[WONUM],[WO_STATUS],[DNMC_Fetch_Date] FROM [ESRI].[ServicesData] "))
