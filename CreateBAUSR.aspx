<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="True" Inherits="WebAppForm.CreateBAUSR"
    Title="BAU - Create SR" CodeBehind="CreateBAUSR.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtReportedBy" Display="None" EnableClientScript="true"
                        ...
                        <tr>
                            ...
                            <td class="required"><span style="color: red;">* </span>SP Group:</td>
                            <td>
                                <asp:TextBox ID="TxtboxSRGrp" Text="DR_CSRL2" runat="server" class="textfield" Style="margin-left: 9px;" Width="186" />
                         <%--            <asp:ImageButton runat="server" ImageUrl="images/search.png" OnClientClick="SelectLocation()" Width="20" Height="20" ID="ImageButton2" Style="vertical-align: middle;" />--%>
