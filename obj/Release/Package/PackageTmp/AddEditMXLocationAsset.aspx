        ...
        <tr>
            <td>
                ...
                <div id="divone">
                    <table width="100%">
                        <tr>
                            <td class="required"><asp:Label ID="lblFrmwrk" runat="server" Visible="false" Text="EAMS Framework Zone"></asp:Label></td>
                            ...
                            <td class="required"><asp:Label ID="lblAssetStatus" runat="server" Visible="false" Text="EAMS Asset Status"></asp:Label></td>
                            <td style="padding-left: 10px;">
                        ...
                        <tr>
                            <td class="required" align="right" style="text-align: right;">
                                <span style="color: red;">* </span><span class="normal">Hierarchical SCADA Name:</span>
                            </td>
                            <td class="requiredvalue" style="text-align: left;">
                                <asp:TextBox ID="txtSiteName" runat="server" class="textfield" Width="185" MaxLength="30"></asp:TextBox>
                            ...
                            <td class="required" align="left" style="text-align: right;">
                                <span style="color: red;">* </span><span class="normal">Asset Location:</span>
                                
                            </td>
                            <td class="requiredvalue">
                                <asp:TextBox ID="lblSiteName" runat="server" class="textfield" Width="185" MaxLength="30"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="requiredvalue" style="text-align: left;">
                                <asp:TextBox ID="txtAssetId" runat="server" class="textfield" Width="185" MaxLength="30"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtAssetId" Display="None"
                                    ValidationGroup="test" Text="*" ErrorMessage="Assset ID is Required" ForeColor="white" />
                            ...
                            <td class="required" align="left" style="text-align: right;">
                                <span class="normal">Asset Tag :</span>
                            </td>
                            <td class="requiredvalue">
                                <asp:TextBox ID="txtAssetTag" runat="server" class="textfield" MaxLength="40" Width="186" />                                
                            </td>
                        </tr>
                         <tr>                           
                            <td class="required" align="right" style="text-align: right;">
                               <span class="normal">SCADA Tag Name :</span>
                            </td>
                            <td class="requiredvalue" style="text-align: left;">
                                <asp:TextBox ID="txtTagName" runat="server" class="textfield" Width="185"></asp:TextBox>
                            </td>
                             <td class="required" align="right" style="text-align: right;">
                               <span class="normal">Asset Description :</span>
                            </td>
                            <td class="requiredvalue" style="text-align: left;">
                        ...
                        <tr>
                            <td class="required" align="right" style="text-align: right;">
                               <span class="normal">Main Pump :</span>
                            </td>
                            <td class="requiredvalue" style="text-align: left;">
                                <asp:CheckBox ID="chkMainPump" runat="server" Checked="false" />
                            </td>
                             <td class="required" align="right" style="text-align: right;">
