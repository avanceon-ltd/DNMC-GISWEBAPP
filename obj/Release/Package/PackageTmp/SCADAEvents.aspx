<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="True" Inherits="WebAppForm.SCADAEvents"
    Title="SCADA Events Report" CodeBehind="SCADAEvents.aspx.cs" %>
...
<div style="padding-left: 10px;">
    <div>
        <h1 class="heading">SCADA Historical Events Overview - <asp:Label runat="server" ID="lblRecordCount" ForeColor="White" Font-Bold="true" /> Record(s)</h1>
    </div>
        <div class="modal fade" id="myModal" role="dialog" >
        <div class="modal-dialog modal-sm" >
            <div style="background-color: #022130; font-family: Segoe UI Light; color: white; width: 400px; margin: 0 auto;" class="modal-content">
                <div class="modal-header" style="padding: 6px; border-bottom: 1px solid #4c636f;">
                    ...
                    <h4 class="modal-title" style="font-weight: bold; font-size: 14px;">Download: SCADA Alarms Report</h4>
                </div>
                ...
                <td>
                    <table id="divone" style="text-align: right">
                         <tr>
                            ...
                            <td>
                                   <asp:DropDownList ID="catchmentList" runat="server" CssClass="textfield" Width="200px" style="width: 182px; margin: 9px;"
                                        DataSourceID="SqlDataSource1" DataTextField="" DataValueField="" AppendDataBoundItems="true">
                            ...
                            <td>
                                   <asp:DropDownList ID="AssetList" runat="server" CssClass="textfield" Width="200px" style="width: 182px; margin: 9px;"
                                        DataSourceID="SqlDataSource2" DataTextField="" DataValueField="" AppendDataBoundItems="true">
                                   <asp:ListItem Value="All"></asp:ListItem>
                                    </asp:DropDownList>
                             </td>
                             <td>
                            ...
                            <td>
                                   <asp:DropDownList ID="TagNameList" runat="server" CssClass="textfield" Width="200px" style="width: 182px; margin: 9px;"
                                        DataSourceID="SqlDataSource3" DataTextField="" DataValueField="" AppendDataBoundItems="true">
                                   <asp:ListItem Value="All"></asp:ListItem>
                                    </asp:DropDownList>
                             </td>
                             </td>
                             ...
                             <td align="right" style="padding-left: 10px;"><asp:Button ID="btnDownload" runat="server" CssClass="simplebutton1" Text="Download" Font-Underline="true" OnClick="btnDownload_Click" width="100px" BackColor="#006600"/></td>
                             </tr>
            ...
            <tr>
                <td style="padding-left: 10px;">
                    ...
                    <asp:GridView ID="gvCustomers" Font-Size="12px" Font-Names="Segoe UI Light" runat="server" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            <asp:BoundField DataField="EventStamp" HeaderText="EventStamp" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="130" />
                            <asp:BoundField DataField="Area" HeaderText="Area" />        
                            <asp:BoundField DataField="TagName" HeaderText="Tag Name" ItemStyle-Width="130" />                           
                            <asp:BoundField DataField="Description" HeaderText="Description" ItemStyle-Width="300" />
                            <asp:BoundField DataField="Value" HeaderText="Value" ItemStyle-Width="60" />
                        </Columns>
