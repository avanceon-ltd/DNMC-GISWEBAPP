                ...
                <div id="divone">
                    <table width="100%">
                        <tr>
                            ...
                            <td class="required">
                                <asp:Label ID="lblChamberStatus" runat="server" Visible="false" Text="EAMS Chamber Status"></asp:Label></td>
                        ...
                        <tr>
                            <td class="required" align="left" style="text-align: right;">
                                <asp:Label ID="Label1" runat="server" Text="Facility Name:" Visible="false"></asp:Label>
                            </td>
                            <td class="requiredvalue">

                                <asp:CheckBox ID="isCustomer" runat="server" AutoPostBack="true" CssClass="Customer" Checked="false" OnCheckedChanged="isCustomer_CheckedChanged"  />
                                <label runat="server">Customer?</label>
                            </td>
                        </tr>
                        <tr>
                            <td class="required" align="right" style="text-align: right;">
                                <span style="color: red;">* </span><span class="normal">GIS Ref:</span>
                            </td>
                            <td class="requiredvalue" style="text-align: left;">
                                <asp:TextBox ID="GISRef" runat="server" class="textfield" Width="185" MaxLength="18" ReadOnly="true"></asp:TextBox>
                                <ajax:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server"
                                    FilterType="Numbers, Custom" ValidChars="."
                                    TargetControlID="txtLong">
                                </ajax:FilteredTextBoxExtender>

                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtLong" Display="None"
                                    ValidationGroup="test" Text="*" ErrorMessage="GIS Ref is Required" ForeColor="white" />

                            </td>

                            <td class="required" align="left" style="text-align: right;">
                                <span style="color: red;">* </span><span class="normal">CRMS ID:</span>
                            </td>
                            <td class="requiredvalue">
                                <asp:TextBox ID="CRMSID" runat="server" class="textfield" MaxLength="18" Width="186" ReadOnly="true"></asp:TextBox>
                                <ajax:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                                    FilterType="Numbers, Custom" ValidChars="."
                                    TargetControlID="txtLat">
                                </ajax:FilteredTextBoxExtender>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtLat" Display="None"
                                    ValidationGroup="test" Text="*" ErrorMessage="CRMS ID is Required" ForeColor="white" />
                            </td>
                        </tr>
                        <tr>
                            <td class="required" align="right" style="text-align: right;">
                                <span style="color: red;">* </span><span class="normal">Customer Name:</span>
                            </td>
                            <td class="requiredvalue" style="text-align: left;">
                                <asp:TextBox ID="CustomerName" runat="server" class="textfield" Width="185" MaxLength="18" ReadOnly="true"></asp:TextBox>
                                <ajax:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server"
                                    FilterType="Numbers, Custom" ValidChars="."
                                    TargetControlID="txtLong">
                                </ajax:FilteredTextBoxExtender>

                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtLong" Display="None"
                                    ValidationGroup="test" Text="*" ErrorMessage="Customer Name is Required" ForeColor="white" />

                            </td>

                            <td class="required" align="left" style="text-align: right;">
                                <span style="color: red;">* </span><span class="normal">Service Location:</span>
                            </td>
                            <td class="requiredvalue">
                                <asp:TextBox ID="ServiceLocation" runat="server" class="textfield" MaxLength="500" Width="186" ReadOnly="true"></asp:TextBox>
                                <ajax:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server"
                                    FilterType="Numbers, Custom" ValidChars="."
                                    TargetControlID="txtLat">
                                </ajax:FilteredTextBoxExtender>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtLat" Display="None"
                                    ValidationGroup="test" Text="*" ErrorMessage="Service Location is Required" ForeColor="white" />
                            </td>
                        </tr>
                        <tr>
                            <td class="required" align="left" style="text-align: right;">
