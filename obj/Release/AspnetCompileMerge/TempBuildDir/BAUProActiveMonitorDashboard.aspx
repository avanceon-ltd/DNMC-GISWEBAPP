<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BAUProActiveMonitorDashboard.aspx.cs" Inherits="WebAppForm.BAUProActiveMonitorDashboard" %>
     ...
     <div>
          <div class="headerSection">
               <p align="center" style="font-weight: bold; font-size: 24px; font-family: 'Segoe UI Light', Arial;">
                    BAU - DSS System Pro-Active Monitoring 
                  <span>
                       (<%= currentSystem %>)
                  </span>
                   <br />
