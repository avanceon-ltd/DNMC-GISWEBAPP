...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DuplicateSRAssignment.aspx.cs" Inherits="WebAppForm.DuplicateSRAssignment" 
        ...
        <div class="modal-dialog modal-sm">
            <div style="background-color: #022130; font-family: Segoe UI Light; color: white; width: 300px; margin: 0 auto;" class="modal-content">
                <div class="modal-header" style="padding: 6px; border-bottom: 1px solid #4c636f;">
                    ...
                    <h4 class="modal-title" style="font-weight: bold; font-size: 14px;">Duplicate Complaint Assignment: MessageBox</h4>
                </div>
