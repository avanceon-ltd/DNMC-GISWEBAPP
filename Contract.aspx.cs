...
namespace WebAppForm
{
    public partial class Contract : System.Web.UI.Page
    {
        ...
        public void BindGridView(string text1, string column1, string text2, string column2, int pageNo)
        {
            ...
            gvContractors.PageSize = pageSize;
            ...
            query = @"SELECT pv.[CONTRACTID],pv.[CONTRACTNUM],c.COMPANY,pv.DESCRIPTION,c.NAME,c.COMPANY_KEY 
            ...
            try
            {
                ...
                gvContractors.VirtualItemCount = totalRows;
                lblRecordCount.Text = totalRows.ToString();
                gvContractors.DataSource = dataSet.Tables[0];
